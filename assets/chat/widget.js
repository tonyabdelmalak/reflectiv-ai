...
(function(){
  ...
  var TONY_PERSONAS = [
  { name: "Coworker", url: "./assets/chat/personas/coworker.md" },
  { name: "Manager",  url: "./assets/chat/personas/manager.md"  },
  { name: "Family",   url: "./assets/chat/personas/family.md"   },
  { name: "Friend",   url: "./assets/chat/personas/friend.md"   },
]
